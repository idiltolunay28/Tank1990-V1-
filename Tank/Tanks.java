...
abstract class Tanks implements GameObjects {
    ...
    protected long moveDuration = 1000;
    ...
    public void move(Map<String, Double> move, StageControl stageControl) { // !
        ...
        if (up == -10.0 && down != -10.0 && !stageControl.checkObstacle(this, "down")) {
            y -= speed;
            setDirection("down");
        } else if (up != -10 && down == -10 && !stageControl.checkObstacle(this, "up")) {
            y += speed;
            setDirection("up");
        } else if (up != -10 && down != -10 && !stageControl.checkObstacle(this, "down")) {
            y += speed;
            setDirection("down");
        } else if (up == -10 && down == -10) {
            if (left == -10 && right != -10 && !stageControl.checkObstacle(this, "right")) {
                x += speed;
                setDirection("right");
            } else if (left != -10 && right == -10 && !stageControl.checkObstacle(this, "left")) {
                x += speed;
                setDirection("left");
            } else if (left != -10 && right != -10 && !stageControl.checkObstacle(this, "right")) {
                x += speed;
                setDirection("right");
